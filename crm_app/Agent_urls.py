...
urlpatterns = [
    ...
    path("Agent/Document/<int:id>", agentdocument, name="Agent_Document"),
    ...
    path(
        "Agent/AppointmentList/",
        appointment_list.as_view(),
    ...
    path(
        "Agent/edit/Enrolled/Application/<int:id>",
        edit_enrolled_application,
        name="Agent_edit_enrolled_application",
    ),
    path(
        "Agent/Educaion/Summary/<int:id>",
        education_summary,
        name="Agent_education_summary",
    ),
    path("Agent/Test/Score/<int:id>", test_score, name="Agent_test_score"),
    path(
        "Agent/Test/Score/Delete/<int:id>",
        delete_test_score,
        name="Agent_delete_test_score",
    ),
    path(
    ...
    path(
        "Agent/Background/Infromation/<int:id>",
        background_information,
        name="Agent_background_information",
    ),
    ...
    path(
        "leads/Packageenquiry/<int:id>",
        AgentPackageEnquiryCreateView.as_view(),
        name="Agent_package_enquiry",
    ),
    path("Agent/Resend/<int:id>/", resend, name="resend"),
]
